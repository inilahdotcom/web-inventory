  ...
  return (
    <div className="flex min-h-svh min-w-0 flex-col bg-[#f7f8fa] text-[#1c1c1e]">
      <div className="flex h-16 flex-none items-center gap-3.5 border-b border-[#e0e2e8] bg-white pr-4 pl-16 sm:pr-6 sm:pl-16 lg:px-6">
        <div className="flex h-10 w-full min-w-0 max-w-72 items-center gap-2 rounded-lg border border-[#e0e2e8] bg-[#f7f8fa] px-3">
          <span className="shrink-0 text-sm text-[#a5a8b5]">⌕</span>
          <span className="truncate text-sm text-[#a5a8b5]">Cari nama atau email…</span>
        </div>
        <span className="ml-auto flex h-10 shrink-0 cursor-pointer items-center justify-center whitespace-nowrap rounded-full bg-[#1c1c1e] px-4 text-sm font-semibold text-white sm:px-5">
            ...
            <div className="min-w-[1000px]">
              ...
              <div className="grid h-16 grid-cols-[1fr_16rem_9rem_8rem_11rem_8rem] items-center gap-3.5 border-b border-[#eef0f3] px-5">
                <span className="flex items-center gap-2.5">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#ffc6c6] text-xs font-semibold text-[#600000]">RS</span>
                  <span className="truncate text-sm font-semibold">Rizky Saputra</span>
                </span>
              ...
              <div className="grid h-16 grid-cols-[1fr_16rem_9rem_8rem_11rem_8rem] items-center gap-3.5 border-b border-[#eef0f3] px-5">
                <span className="flex items-center gap-2.5">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#c3faf5] text-xs font-semibold text-[#187574]">DA</span>
                  <span className="truncate text-sm font-semibold">Dewi Anggraini</span>
                </span>
              ...
              <div className="grid h-16 grid-cols-[1fr_16rem_9rem_8rem_11rem_8rem] items-center gap-3.5 border-b border-[#eef0f3] px-5">
                <span className="flex items-center gap-2.5">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#fde0f0] text-xs font-semibold text-[#600000]">BH</span>
                  <span className="truncate text-sm font-semibold">Budi Hartono</span>
                </span>
              ...
              <div className="grid h-16 grid-cols-[1fr_16rem_9rem_8rem_11rem_8rem] items-center gap-3.5 border-b border-[#eef0f3] px-5">
                <span className="flex items-center gap-2.5">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#fff8e0] text-xs font-semibold text-[#746019]">SF</span>
                  <span className="truncate text-sm font-semibold">Sari Fitriani</span>
                </span>
              ...
              <div className="grid h-16 grid-cols-[1fr_16rem_9rem_8rem_11rem_8rem] items-center gap-3.5 px-5">
                <span className="flex items-center gap-2.5">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#eef0f3] text-xs font-semibold text-[#8e91a0]">AW</span>
                  <span className="truncate text-sm font-semibold text-[#8e91a0]">Agus Wijaya</span>
                </span>
