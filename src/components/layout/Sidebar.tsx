    ...
    <div className="flex h-full w-full flex-col">
      <div className="flex h-16 items-center px-5.5">
        ...
        <span className="ml-2.5">
          ...
          <span className="block text-xs leading-3 text-[#777780]">
            General Affairs
          </span>
        </span>
      ...
      <nav className="flex-1 px-3.5 pt-3">
        ...
        <p className="mt-6 mb-2.5 px-2.5 text-[10px] font-bold text-[#777780]">
          ADMIN
        </p>
        <div className="space-y-1">
      ...
      <div className="p-3.5">
        <span className="flex h-12 items-center gap-2.5 rounded-xl bg-[#343438] px-2.5">
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-xs leading-3 font-bold text-white">
              Rizky Saputra
            </span>
            <span className="block truncate pt-px text-xs leading-3 text-[#858896]">
              Admin GA
            </span>
          </span>
        </span>
...
function NavItem({
  ...
  return (
    <Link
      to={to}
      onClick={onNavigate}
      className="flex h-8 items-center rounded-lg px-2.5 text-xs font-medium text-[#a5a8b5]"
      activeProps={{
        className:
          "flex h-8 items-center rounded-lg bg-[#3a3a3e] px-2.5 text-xs font-bold text-white",
      }}
    >
      {({ isActive }) => (
        <>
